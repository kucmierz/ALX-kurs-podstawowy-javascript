...
})({"bGCgQ":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "4523cacc56c92221";
"use strict";
...
},{}],"hIjRI":[function(require,module,exports) {
...
const handleNewPost = (ev)=>{
    ev.preventDefault();
    if (!author.value || message.value.length < 3) return alert("Formularz wypelniony blednie");
    const newMsg = {
        createdAt: Date.now(),
        author: author.value,
    ...
    (0, _database.push)(messageRef, newMsg);
    // zerowanie formularza
    author.value = "";
    message.value = "";
};
const handleRemoveMsg = (ev)=>{
    if (ev.target.dataset.id) (0, _database.remove)((0, _database.ref)((0, _firebase.database), `messages/${ev.target.dataset.id}`));
    if (ev.target.dataset.likeid) {
        ...
        console.log(newLike);
        (0, _database.set)((0, _database.ref)((0, _firebase.database), `messages/${ev.target.dataset.likeid}`), {
...
},{"@firebase/app":"3AcPV","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["bGCgQ","hIjRI"], "hIjRI", "parcelRequireb556")

//# sourceMappingURL=index_firebase.56c92221.js.map
