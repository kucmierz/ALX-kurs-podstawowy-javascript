...
})({"cVUju":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "0aa50b8560dfe562";
"use strict";
...
},{}],"4AmEE":[function(require,module,exports) {
...
const messageRef = (0, _database.ref)((0, _firebase.database), "messages");
let messages = [];
const renderList = (array)=>{
    ...
    array.forEach((message)=>{
      ...
      <li class="message">
        ...
        <p> ${message.message} </p>
        ${message.authorId === AUTHOR_ID ? `<button class="delete-button" data-id="${message.id}">Usuń</button>` : ""}
        ...
        <div class="hidden">
          <ul class="comments">
            ${!message.comments ? "" : Object.values(message.comments).map((comment)=>{
...
const handleSubmit = (event)=>{
    ...
    (0, _database.push)(messageRef, newMessage);
...
const handleLikeClick = (idToLike)=>{
    ...
    (0, _database.set)((0, _database.ref)((0, _firebase.database), `messages/${idToLike}`), messageToChange);
};
const handleComment = (postid, author, message)=>{
    ...
    (0, _database.set)((0, _database.ref)((0, _firebase.database), `messages/${postid}`), messageToChange);
};
const handleListClick = (event)=>{
    if (event.target.dataset.id) // messages = messages.filter(message => {
    //   return message.id !== parseInt(event.target.dataset.id)
    // })
    (0, _database.remove)((0, _database.ref)((0, _firebase.database), `messages/${event.target.dataset.id}`));
    if (event.target.classList.contains("like-it-button")) handleLikeClick(event.target.dataset.messageid);
    if (event.target.classList.contains("show-comments")) {
        ...
        event.target.innerText = event.target.innerText.includes("Zobacz") ? `Ukryj komentarze (${commentsNumber})` : `Zobacz komentarze (${commentsNumber})`;
...
const handleData = (data)=>{
    ...
    if (!sortByLikes.checked) messages = messagesWithIdsFromFB.sort((prev, next)=>prev.createdAt > next.createdAt ? -1 : 1);
    else messages = messagesWithIdsFromFB.sort((prev, next)=>prev.likes > next.likes ? -1 : 1);
    renderList(messages);
};
const handleClickSort = (ev)=>{
    if (ev.target.checked) messages.sort((a, b)=>a.likes >= b.likes ? -1 : 1);
    else messages.sort((a, b)=>a.createdAt >= b.createdAt ? -1 : 1);
    renderList(messages);
};
const handleSearchSubmit = (ev)=>{
    ev.preventDefault();
    if (searchedPhrase.value.length === 0) filteredMessages = messages;
    else {
...
// Websockets
(0, _database.onValue)(messageRef, handleData);

},{"firebase/database":"SJ4UY","./firebase":"an1YM"}],"SJ4UY":[function(require,module,exports) {
...
var process = require("35b4e9cb8dbdbf1f");
...
},{"35b4e9cb8dbdbf1f":"d5jf4","@firebase/app":"3AcPV","@firebase/component":"bi1VB","@firebase/util":"ePiK6","@firebase/logger":"fZmft","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d5jf4":[function(require,module,exports) {
...
var process = require("9fe7963fc38e8233");
var global = arguments[3];
const CONSTANTS = {
    /**
...
},{"9fe7963fc38e8233":"d5jf4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gkKU3":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"an1YM":[function(require,module,exports) {
...
},{"@firebase/app":"3AcPV","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["cVUju","4AmEE"], "4AmEE", "parcelRequireb556")

//# sourceMappingURL=damian_index.60dfe562.js.map
